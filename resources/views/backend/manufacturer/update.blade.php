...
<div class="content">
   @if (Session::has('success'))
    ...
    @endif
    <form action="{{ route('admin.manufacturer.update', $Stores->id) }}" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
        <div class="panel panel-body results">
            <div class="row">
                <div class="col-md-12">
                    <fieldset>
                        <legend class="text-semibold"><i class="icon-reading position-left"></i>Cập nhật hãng</legend>
                        <div class="row">
