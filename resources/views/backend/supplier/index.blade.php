...
<!-- Dashboard content -->
   ...
   <div class="page-header">
   	<div class="page-header-content">
   		<div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class=" text-semibold ">Nhà cung cấp</span></h4>
           ...
           <div class="heading-elements">
           	 <div class="heading-btn-group">
                     ...
                     <a href="{{ route('admin.supplier.create') }}" class="btn btn-link btn-float text-size-small has-text legitRipple text-slate" >                     
 ...
 <div class="panel panel-flat">
            <div class="panel-heading">
                ...
                <h5 class="panel-title ">Danh sách nhà cung cấp</h5> 
                 ...
                 @foreach($Stores as $key=>$value)
                    <tr>
                       ...
                       <th style="text-align: center">
                            ...
                            <a  href="{{ route('admin.supplier.edit', $value->id) }}" title="Chỉnh sửa" class="text-success">
                                <i class="icon-pencil"></i>
                            </a>
                           
                            <form action="{{ route('admin.supplier.destroy',  $value->id ) }}" method="POST">
                                {!! method_field('DELETE') !!}
                                {!! csrf_field() !!}
