...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Cập nhật nhà cung cấp</span></h4>
...
<div class="content">
   @if (Session::has('success'))
    ...
    @endif
    <form action="{{ route('admin.supplier.update', $Stores->id) }}" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
        <div class="panel panel-body results">
            <div class="row">
                <div class="col-md-12">
                    <fieldset>
                        <legend class="text-semibold"><i class="icon-reading position-left"></i>Cập nhật nhà cung cấp</legend>
                        <div class="row">
                        ...
                        <div class="row">
                              <div class="form-group col-md-8">
                                <label class="required">Địa chỉ nhà cung cấp</label>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input name="phone" type="number" class="form-control" value="{{$Stores->phone}}">
