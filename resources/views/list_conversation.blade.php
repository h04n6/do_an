            ...
            <div class="col-sm-3">
                <div class="dung">
                    ...
                    {{-- <div class="key-word-container">
                        <input type="text" class="form-control input-key-word" value="" placeholder="Nhập từ khóa ...">
                    </div> --}}
                    <div class="kwcontainer-father">
                        <div class="kwcontainer"></div>
                    </div>
                    <div class="dung-end"></div>
                </div>
            </div>
        </div>
