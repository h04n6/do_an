...
function owlcarousel() {
    $(".owl-carousel").each(function () {
        var $this = $(this),
                ...
                $interval = ($this.attr('data-interval')) ? $this.data('interval') : 3000;
        $(this).owlCarousel({
            loop: $loop,
            items: $items,
            responsive: {
...
$(document).ready(function () {
    countTraffic(), backtotop(), popupgallery(), owlcarousel(), accordion(), imgskrollr(), preloader(), Tabbar(), header(), progress(), countdown1(), widget(), screensilder(), counter();
});
...
$(document).ready(function () {
    $("#registerForm").validate({
        ...
        messages: {
            fullname: {
                required: "Bạn còn thiếu họ tên",
                minlength: "Tên của bạn phải lớn hơn 2 kí tự"
            },
            email: {
                required: "Bạn còn thiếu email",
                email: "Định dạng email của bạn chưa đúng"
            },
            tel: {
                required: "Bạn còn thiếu số điện thoại",
            },
            basis_id: {
                required: "Hãy chọn cơ sở gần bạn nhât"
            },
            schedule_id: {
                required: "Hãy chọn lịch học phù hợp vs bạn nhât"
            }
        },
...
$(document).on('scroll', function () {
    if ($(this).scrollTop()+200 >= $('.iq-success').position().top) {
