...
class Products extends Model
{
    ...
    public function productImages() {
        return $this->hasMany('App\ProductImage', 'id_product', 'id_product');
    }

    //  public function ProductSize() {
    //     return $this->belongsTo('App\ProductSize', 'id_product', 'id_product');
    // }
    //   public function ProductColor() {
    //     return $this->belongsTo('App\ProductColor', 'id_product', 'id_product');
    // }
